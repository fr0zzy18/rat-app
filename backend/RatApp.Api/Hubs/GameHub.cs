...
namespace RatApp.Api.Hubs
{
    public class GameHub : Hub
    {
        ...
        public async Task LeaveGame(string gameId)
        {
            ...
            int userId;
            // Get the userId associated with the connection that just left the group
            ConnectedUsers.TryGetValue(Context.ConnectionId, out userId);

            // Now call the shared logic to update game status
        ...
        // Shared logic to update game status when a player leaves or disconnects
